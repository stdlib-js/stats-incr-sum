...
```javascript
import incrsum from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-sum@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-sum/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-incr-sum/actions/workflows/test.yml?query=branch:v0.2.2
